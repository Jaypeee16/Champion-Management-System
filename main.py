...
class LoginApp(ctk.CTk):
    def __init__(self):
        ...
        self.center_window(self, 450, 650)
        ...
        try:
            ...
            self.logo_label = ctk.CTkLabel(self.main_frame, image=self.main_logo_img, text="")
            self.logo_label.pack(pady=(30, 10))
        except FileNotFoundError:
            self.logo_label = ctk.CTkLabel(self.main_frame, text="[ LOGO ]", font=("Inter", 20, "bold"), text_color="green")
            self.logo_label.pack(pady=(30, 10))

        self.label = ctk.CTkLabel(self.main_frame, text="Champion Fine Tooling Corp.", font=("Inter", 22, "bold"), text_color="#1A1A1A")
        self.label.pack(pady=(0, 2))

        self.sub_label = ctk.CTkLabel(self.main_frame, text="Automated Management System", font=("Inter", 16), text_color="#888888")
        self.sub_label.pack(pady=(0, 30))

        # --- STANDARD UX GUIDELINES FOR INPUTS ---
        # Username Input
        self.user_entry = ctk.CTkEntry(self.main_frame, placeholder_text="Username", width=280, height=40, 
        ...
        # Password Input Frame (Unified look)
        self.pass_frame = ctk.CTkFrame(self.main_frame, fg_color="transparent", width=280, height=40)
        ...
        self.remember_check = ctk.CTkCheckBox(self.main_frame, text="Remember me", font=("Inter", 11), checkbox_width=18, checkbox_height=18, border_color="#D1D5DB")
        self.remember_check.pack(anchor="w", padx=45, pady=(0, 15))

        self.error_banner = ctk.CTkLabel(self.main_frame, text="", fg_color="transparent", text_color="#D8000C", font=("Inter", 11, "bold"), corner_radius=5)
        self.error_banner.pack(fill="x", padx=45, pady=(0, 10))
